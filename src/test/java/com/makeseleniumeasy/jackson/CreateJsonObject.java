...
public class CreateJsonObject {
	...
	public void CreatingNestedJsonObjectTest() throws JsonProcessingException
	{
		...
		bookingDetails.put("firstname", "Shreyansh");
		bookingDetails.put("lastname", "Jain");
		...
		// THEN
		   .then()
			   .assertThat()
			   .statusCode(200)
			   .body("booking.firstname", equalTo("Shreyansh"))
			   .body("booking.lastname", equalTo("Jain"))
			   .body("booking.totalprice", equalTo(1000))
			   .body("booking.depositpaid", equalTo(true))
			   .body("booking.additionalneeds", equalTo("Lunch"))
			   .body("booking.bookingdates.checkin", equalTo("2021-07-01"))
			   .body("booking.bookingdates.checkout", equalTo("2021-07-01"))
			   .log()
			   .all();
	} 
}